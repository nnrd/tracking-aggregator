            ...
            <?= DetailView::widget([
                ...
                'attributes' => [
                    ...
                    [
                        ...
                        'format' => 'html',
                        'value' => isset($model->tracker_status) ? Html::bslabel($model->getTrackerStatusLabels()[$model->tracker_status], $model->getTrackerStatusWarningLevels()[$model->tracker_status]) : null,
                    ],
                ],
            ]) ?>
        </div>
