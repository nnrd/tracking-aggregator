...
class Tracking extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'status' => Yii::t('app', 'Priority'),
            'tracker_status' => Yii::t('app', 'Status'),
    ...
    {
        return [
            self::STATUS_DISABLED => 'unimportant',
            self::STATUS_NORMAL => 'info',
            self::STATUS_URGENT => 'danger',
        ];
    }

    public static function getTrackerStatusWarningLevels()
    {
        return [
            'info', // pending
            'warning', // notfound
    ...
    public static function getTrackerStatusNames()
    {
        return [
            'pending',
            'notfound',
    ...
    {
        return array_flip(self::getTrackerStatusNames());
    }
